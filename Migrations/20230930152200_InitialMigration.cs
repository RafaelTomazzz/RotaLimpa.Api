        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RotaIdRota = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MotoristaIdMotorista = table.Column<int>(type: "int", nullable: false),
                    IdRota = table.Column<int>(type: "int", nullable: false),
                    RotaIdRota = table.Column<int>(type: "int", nullable: false),
                    IdFrota = table.Column<int>(type: "int", nullable: false),
                    FrotaId_Veiculo = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Trajeto", x => x.IdTrajeto);
                    table.ForeignKey(
                        name: "FK_Trajeto_Frota_FrotaId_Veiculo",
                        column: x => x.FrotaId_Veiculo,
                        principalTable: "Frota",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Trajeto_Motorista_MotoristaIdMotorista",
                        column: x => x.MotoristaIdMotorista,
                        principalTable: "Motorista",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Trajeto_Rota_RotaIdRota",
                        column: x => x.RotaIdRota,
                        principalTable: "Rota",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IdTrajetoId = table.Column<int>(type: "int", nullable: false),
                    TipoOcorrencia = table.Column<int>(type: "int", nullable: false),
                    MtOcorrencia = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Data domento da ocorrência")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ocorrencia", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Ocorrencia_Trajeto_IdTrajetoId",
                        column: x => x.IdTrajetoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ocorrencia_IdTrajetoId",
                table: "Ocorrencia",
                column: "IdTrajetoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Trajeto_FrotaId_Veiculo",
                table: "Trajeto",
                column: "FrotaId_Veiculo");

            migrationBuilder.CreateIndex(
                name: "IX_Trajeto_MotoristaIdMotorista",
                table: "Trajeto",
                column: "MotoristaIdMotorista");

            migrationBuilder.CreateIndex(
                name: "IX_Trajeto_RotaIdRota",
                table: "Trajeto",
                column: "RotaIdRota");
        }
