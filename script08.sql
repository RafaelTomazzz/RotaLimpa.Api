...
CREATE TABLE [Colaborador] (
    ...
    CONSTRAINT [FK_Colaborador_Empresa_EmpresaId] FOREIGN KEY ([EmpresaId]) REFERENCES [Empresa] ([Id]) ON DELETE NO ACTION
);
GO
...
CREATE TABLE [Setor] (
    ...
    CONSTRAINT [FK_Setor_Empresa_EmpresaId] FOREIGN KEY ([EmpresaId]) REFERENCES [Empresa] ([Id]) ON DELETE NO ACTION
);
GO
...
CREATE TABLE [SetorVeiculo] (
    ...
    CONSTRAINT [PK_SetorVeiculo] PRIMARY KEY ([IdSetor]),
...
VALUES (N'20231014214616_InitialMigration', N'7.0.10');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20231101020859_ServiceERepository', N'7.0.10');
GO
