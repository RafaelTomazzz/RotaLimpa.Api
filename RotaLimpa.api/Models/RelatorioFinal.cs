...
namespace RotaLimpa.Api.Models
{
    ...
    public class RelatorioFinal
    {
        ...
        public async void CriarPDF(RelatorioFinal relatorioFinal, Trajeto trajeto, Setor setor, IEnumerable<Ocorrencia> listaOcorrencia, Motorista motorista)
        {
            ...
            Paragraph paragTitulo = new Paragraph("RELAT�RIO DO TRAJETO" + "\n \n", fontTitulo);
            paragTitulo.Alignment = Element.ALIGN_CENTER;

            doc.Add(paragTitulo);

            //informa�oes do trajeto

            Paragraph tituloTrajeto = new Paragraph("   Informa��es do Trajeto \n \n", fontSubtitulo);
            doc.Add(tituloTrajeto);

            Phrase idTrajeto = new Phrase("Identidica��o do Trajeto: " + trajeto.Id.ToString() + "\n", fontText);
            ...
            Paragraph tituloMotorista = new Paragraph("   Informa��es do Motorista \n \n", fontSubtitulo);
            doc.Add(tituloMotorista);

            Phrase idMotorista = new Phrase("Identifica��o do Motorista: " + motorista.Id.ToString() + "\n", fontText);
            ...
            {
                Phrase listOcorrencia = new Phrase("   Lista de Ocorr�ncias", fontSubtitulo);
                ...
                Paragraph coluna2 = new Paragraph("Tipo de Ocorr�ncia", fontTable);
                coluna2.Alignment = Element.ALIGN_CENTER;
                Paragraph coluna3 = new Paragraph("Momento da Ocorr�cia", fontTable);
                ...
                foreach (Ocorrencia ocorrencia in listaOcorrencia)
                {
                    ...
                    {
                        Paragraph tipo = new Paragraph("Colis�o", fontTable);
                    ...
                    {
                        Paragraph tipo = new Paragraph("�rvore Ca�da", fontTable);
                        tipo.Alignment = Element.ALIGN_CENTER;
                        var cell2 = new PdfPCell(tipo);
                        table.AddCell(cell2);
                    }
                    ...
                    {
                        Paragraph tipo = new Paragraph("Sem Sa�da", fontTable);
                        tipo.Alignment = Element.ALIGN_CENTER;
                        var cell2 = new PdfPCell(tipo);
                        table.AddCell(cell2);
                    }
